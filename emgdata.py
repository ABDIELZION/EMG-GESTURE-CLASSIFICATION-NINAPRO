...
# Replace 'st_fl_kl.mat' with your actual filename
mat_data = scipy.io.loadmat('S1_E1_A1.mat')

# This creates the 'emg_signal' variable that was missing
emg_signal = mat_data['emg']

# --- 2. CONFIGURATION ---
sampling_rate = 2000  # 2kHz from NinaPro
seconds_to_plot = 5
num_samples = seconds_to_plot * sampling_rate

# Now this line won't throw an error!
